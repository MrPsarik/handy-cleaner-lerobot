...
ROBOT_PORT = "/dev/ttyACM0"  # Windows example. Linux example: "/dev/ttyACM0"
...
POLICIES = {
    ...
    1: {
        "name": "scrap_paper",
        "policy_path": "MrPsarik/movement1",
        "task": "Put the scrap paper in the paper bin",
    },
    2: {
        "name": "toy",
        "policy_path": "MrPsarik/movement2",
...
def run_act_policy_blocking(class_id: int):
    ...
    command = [
        "/home/mrpsarik/miniforge3/envs/lerobot/bin/lerobot-replay", 
